...
logo = PhotoImage(file="ZenithFitlogo.png")

LeftFrame = Frame(jan, width=197, height=300, bg="CYAN", relief="raise")
LeftFrame.pack(side=LEFT)

RightFrame = Frame(jan, width=400, height=300, bg="CYAN", relief="raise")
...
PassLabel = Label(RightFrame, text="Password:", font=("Century Gothic",20), bg="WHITE", fg="White")
